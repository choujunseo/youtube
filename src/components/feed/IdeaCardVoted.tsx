...
export default function IdeaCardVoted(props: IIdeaCardVotedProps) {
  const { idea, onSeeDetail, tagRowPrefix, tagRowSuffix, hideDetailButton = false } = props;
  ...
  return (
    <article className="rounded-2xl border border-blue-100 bg-gradient-to-b from-blue-50/40 to-white p-4 shadow-sm">
      ...
      <div className="mb-4 rounded-xl bg-white p-3 ring-1 ring-blue-100">
        <p className="text-xs text-gray-500">누적 표</p>
        <p className="mt-1 text-lg font-bold tabular-nums text-gray-900">{idea.totalVoteCount}표</p>
      </div>
